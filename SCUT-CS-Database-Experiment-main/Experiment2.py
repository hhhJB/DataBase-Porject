...
class Login_Ui(QtWidgets.QWidget):
    admin_Interface = PyQt5.QtCore.pyqtSignal()
    teacher_Interface = PyQt5.QtCore.pyqtSignal()
    student_Interface = PyQt5.QtCore.pyqtSignal()
    def __init__(self):
        ...
        self.label_Welcome.setText("MIS for Computer Science college of SCUT")
        ...
        self.label_User_ID.setText("User ID")
        self.label_User_ID.setObjectName("label_UserID")

        self.label_Password = QtWidgets.QLabel(Form)
        self.label_Password.setGeometry(PyQt5.QtCore.QRect(95, 130, 71, 20))
        self.label_Password.setObjectName("label_PW")
        ...
        self.label_Invalid_Login_Error.setObjectName("label_Login_Error")
        ...
        self.User_ID_Input.setObjectName("UserInput")
        ...
        self.Button_login.clicked.connect(self.loginCheck)
    ...
    def loginCheck(self):
        ...
        if getPW != "":
            ...
            if len(results) > 0 and str(results[0][2]) == getPW:
                ...
                userChar = char
                if char == "admin":
                    self.admin_Interface.emit()
                elif char == "teacher":
                    self.teacher_Interface.emit()
                elif char == "student":
                    self.student_Interface.emit()
            else:
                self.label_Invalid_Login_Error.setText("User ID or Password incorrect")
                self.label_Invalid_Login_Error.setVisible(True)
        else:
            self.label_Invalid_Login_Error.setText("Password empty!")
            self.label_Invalid_Login_Error.setVisible(True)
...
class Student_Ui(QtWidgets.QWidget):
    ...
    def __init__(self):
        ...
        self.Button_Change_Password.setObjectName("Stu_ChangePW")
        self.Button_Change_Password.setText("Change Password")
...
class Teacher_Ui(QtWidgets.QWidget):
    ...
    def __init__(self):
        ...
        self.Button_CP.setObjectName("Tea_ChangePW")
        self.Button_CP.setText("Change Password")
        self.Button_CP.clicked.connect(lambda: self.cp.emit())

        PyQt5.QtCore.QMetaObject.connectSlotsByName(Form)

class Administor_Ui(QtWidgets.QWidget):
    query = PyQt5.QtCore.pyqtSignal()
    ...
    def __init__(self):
        ...
        Form.setObjectName("Form")
        Form.resize(541, 380)
        Form.setWindowTitle("Administor User")
        self.Button_Query = QtWidgets.QPushButton(Form)
        self.Button_Query.setGeometry(PyQt5.QtCore.QRect(170, 20, 181, 60))
        self.Button_Query.setObjectName("Adimin_Query")
        self.Button_Query.setText("Query")
        self.Button_Query.clicked.connect(lambda: self.query.emit())

        self.Button_MI = QtWidgets.QPushButton(Form)
        self.Button_MI.setGeometry(PyQt5.QtCore.QRect(170, 90, 181, 60))
        self.Button_MI.setObjectName("Adimin_Modify")
        self.Button_MI.setText("Modify Information")
        ...
        self.Button_Change_Password.setObjectName("Adimin_ChangePW")
        self.Button_Change_Password.setText("Change Password")
        ...
        self.Button_Initialize_Database.setObjectName("Adimin_InitDataBase")
        self.Button_Initialize_Database.setText("Initialize\nDatabase")
        ...
        self.Button_Logout.setObjectName("Adimin_Logout")
        self.Button_Logout.setText("Logout")
        self.Button_Logout.clicked.connect(lambda: self.logout.emit())
    ...
    def initialize_database(self):
        reply = QtWidgets.QMessageBox.question(None, 'Initialize Database',
                                     'Are you sure to initialize the database? This operation will initialize the database',
...
class Query_Ui(QtWidgets.QWidget):
    ...
    def __init__(self):
        ...
        self.Button_Student_Info.setText("Student Info")
        ...
        self.Button_Student_Score_Info.setText("Student Score Info")
        ...
        self.Button_Course_Info.setText("Course (Choosing) Info")
        ...
        self.Button_Teacher_Info.setText("Teacher (Teaching) Info")
        ...
        self.Button_Average_Score_Info.setText("Average Score Info")
...
class Controller:
    def show_login(self):
        self.login = Login_Ui()
        self.login.admin_Interface.connect(self.show_admin)
        self.login.teacher_Interface.connect(self.show_teacher)
        self.login.student_Interface.connect(self.show_student)
        self.login.show()
    def show_admin(self):
        self.admin = Administor_Ui()
